...
--
-- Host: localhost:8889
-- Generation Time: Feb 20, 2019 at 19:49 AM
...
--
ALTER TABLE `film`
  MODIFY `filmid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;

--
-- AUTO_INCREMENT for table `kund`
--
ALTER TABLE `kund`
  MODIFY `kundnummer` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=101;

--
-- AUTO_INCREMENT for table `orders`
--
ALTER TABLE `orders`
  MODIFY `ordernummer` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
